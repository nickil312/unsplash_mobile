                    ...
                    posts.length > 0 ? (
                        <VirtualizedList
                            ...
                            renderItem={({item}: { item: Collections }) => (
                                <TouchableOpacity
                                >
                                    <Collection _id={item._id} name={item.name} Isprivate={item.private} last_three_posts={item.last_three_posts} total_photos={item.total_photos} deleted={item.deleted} />
