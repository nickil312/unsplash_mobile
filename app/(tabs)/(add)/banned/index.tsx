...
import {fetchAllPosts, fetchBannedPosts} from "@/globalRedux/posts/asyncActions";
...
export default function banned() {
    ...
    const {status} = useSelector((state: RootState) => state.posts.postsBanned);
    ...
    const loadPosts = async () => {
        ...
        const posts_data = await dispatch(fetchBannedPosts({
            page: page,
        }));
